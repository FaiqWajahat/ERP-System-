...
export default function ThemeSwitcherPage() {
  const { theme, searchQuery, setTheme, setSearchQuery} = useThemeStore();
  ...
  const breadData = [
    ...
    { name: "Theme", href: "/Dashboard/Settings/Theme" },
  ];
      ...
      <div className="w-full max-w-5xl mx-auto">
        ...
        {filteredThemes.length === 0 && (
          <div className="text-center py-10">
            <p className="text-sm text-base-content/40">No themes found matching "{searchQuery}"</p>
          </div>
        )}
