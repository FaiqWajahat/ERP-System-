...
const DashboardSidebarBottom = () => {
  ...
  const userImage = user?.profilePic || "https://i.pravatar.cc/300"
  ...
  return (
    <div className="w-full bg-base-200/70 py-2  border-t border-base-300">
      {/* DROPDOWN WRAPPER 
        1. dropdown-top: Opens upwards
        2. w-full: Takes full width
      */}
      <div className="dropdown dropdown-top w-full">
        
        {/* TRIGGER BUTTON 
          1. hover:bg-base-200: Nice interaction effect
          2. cursor-pointer: Shows it's clickable
        */}
        <div 
          tabIndex={0} 
          role="button" 
